...
public class UncannyUILoader : MonoBehaviour
{
    ...
    public static void Init(InitParams initParams)
    {
        ...
        bool dialogueWindowEnabled = true, inventoryWindowEnabled = true, restWindowEnabled = true;

        dialogueWindowEnabled = settings.GetBool("Dialogue", "Enabled");
        inventoryWindowEnabled  = settings.GetBool("Inventory", "Enabled");
        restWindowEnabled  = settings.GetBool("Rest", "Enabled");
